...
import com.eposp.android.util.ABPixelUtil;
import com.eposp.android.util.Constants;


public class CustomDialog extends Dialog {
	private View _view;
	private TextView title, message, tv_cancel, tv_ok, tv_oneOK, loading,
			Verticalloading;
	private LinearLayout messageGroup, btnGroup, btnGroupOne, vertical_loadGroup,
	...
	public CustomDialog(Context context , int theme, int mode) {
		...
		tv_oneOK = (TextView) _view.findViewById(R.id.tv_one_ok);
		...
		btnGroupOne = (LinearLayout) _view.findViewById(R.id.btn_one);
     ...
     * @return
     */
	public CustomDialog setOneButton(CharSequence text, final View.OnClickListener listener){
		tv_oneOK.setVisibility(View.VISIBLE);
		btnGroupOne.setVisibility(View.VISIBLE);
		tv_oneOK.setText(text);
		tv_oneOK.setOnClickListener(new View.OnClickListener() {
	...
	public CustomDialog setMessage(CharSequence text, int color){
		messageGroup.setVisibility(View.VISIBLE);
		message.setVisibility(View.VISIBLE);
		message.setText(text);
