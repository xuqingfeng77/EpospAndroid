...
public class CommonToast {
    ...
    public void setLayoutGravity(int i) {
        if (i != 0) {
            FrameLayout.LayoutParams params = new FrameLayout.LayoutParams(-2,
                    -2);
            params.gravity = i;
            int j = (int) ABPixelUtil.dp2px(16F,mContext);
    ...
    private class ToastView extends FrameLayout {
        ...
        public void setActionIv(int id){
            actionIv.setVisibility(View.VISIBLE);
            actionIv.setImageResource(id);
        }
        public void setMessageIc(int id){
            messageIc.setVisibility(View.VISIBLE);
            messageIc.setImageResource(id);
        }

        private void init() {
            LayoutInflater.from(getContext()).inflate(
                    R.layout.eposp_android_layout_toast, this, true);
