...
public class OkHttpClientManager {
    ...
    private OkHttpClientManager() {
        ...
        mOkHttpClient.setWriteTimeout(90, TimeUnit.SECONDS);
        mOkHttpClient.setReadTimeout(90, TimeUnit.SECONDS);
        //cookie enabled
        ...
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(final Response response) {
                try {
                    ...
                    Log.d("OkHttpClientManager","string:"+string);
...
//        int changeKey = PreferenceUtils.getIntParam(TestUpdateIPAct.TEST_KEY, -1);
//        switch (changeKey){
//            case -1:
//                return url;
//            case 0://生产
...
//            case 2://测试
//            case 3://自定义
//                String coreUrl = PreferenceUtils.getStringParam(TestUpdateIPAct.CORE_URL);
//                return url.replace(ApiUtil.API_HOST_URL, coreUrl);
//            default:
//                return url;
//        }
        return url;
